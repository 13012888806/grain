 ...
 * @date 2015-6-4
 */
public class CusLevel extends PageQueryParams implements Serializable {
	...
	private String VAR_CD;				// 品种名称
	private String CL_CD;				// 级别编码
	private String CL_NM;				// 级别名称
	private String PRC;					// 价格
	private String UNIT_CD;				// 单位编码
	private String ADJUST_LIMIT;		// 调整额
	private String DISCOUNT_RATE;		// 折扣率
	private String FINAL_PRC;			// 成交价
	...
	private String DEL_FLAG;			// 删除标示符:0已删除，1未删除
	...
	/**
	 * @param cLNM the cL_NM to set
	 */
	public void setCL_NM(String cLNM) {
		CL_NM = cLNM;
	}
	/**
	 * @return the pRC
